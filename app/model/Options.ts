...
export class Options {
    ...
    getMockDataPath(): string {
        switch (this.scope) {
            case 'team-organization':
            case 'organization':
                return 'organization_metrics_response_sample.json';

            case 'team-enterprise':
            case 'enterprise':
                return 'enterprise_metrics_response_sample.json';
 ...
 */
    getSeatsMockDataPath(): string {
        switch (this.scope) {
            case 'team-organization':
            case 'organization':
                return 'organization_seats_response_sample.json';

            case 'team-enterprise':
            case 'enterprise':
                return 'enterprise_seats_response_sample.json';
