...
describe('Options', () => {
  ...
  describe('getMockDataPath', () => {
    test('returns correct path for organization scopes', () => {
      ...
      expect(options1.getMockDataPath()).toBe('organization_metrics_response_sample.json')
      expect(options2.getMockDataPath()).toBe('organization_metrics_response_sample.json')
    })
    ...
    test('returns correct path for enterprise scopes', () => {
      ...
      expect(options1.getMockDataPath()).toBe('enterprise_metrics_response_sample.json')
      expect(options2.getMockDataPath()).toBe('enterprise_metrics_response_sample.json')
    })

    test('returns default path for undefined scope', () => {
      const options = new Options({})

      expect(options.getMockDataPath()).toBe('organization_metrics_response_sample.json')
    })
  })
  ...
  describe('getSeatsMockDataPath', () => {
    test('returns correct path for organization scopes', () => {
      ...
      expect(options1.getSeatsMockDataPath()).toBe('organization_seats_response_sample.json')
      expect(options2.getSeatsMockDataPath()).toBe('organization_seats_response_sample.json')
    })
    ...
    test('returns correct path for enterprise scopes', () => {
      ...
      expect(options1.getSeatsMockDataPath()).toBe('enterprise_seats_response_sample.json')
      expect(options2.getSeatsMockDataPath()).toBe('enterprise_seats_response_sample.json')
    })

    test('returns default path for undefined scope', () => {
      const options = new Options({})

      expect(options.getSeatsMockDataPath()).toBe('organization_seats_response_sample.json')
    })
  })
